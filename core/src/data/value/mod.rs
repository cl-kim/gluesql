...
impl Value {
    ...
    pub fn multiply(&self, other: &Value) -> Result<Value> {
        ...
        match (self, other) {
            ...
            (Interval(a), F64(b)) => Ok(Interval(*a * b.into_inner())),
            (Null, I8(_))
            | (Null, I16(_))
            | (Null, I32(_))
            | (Null, I64(_))
    ...
    pub fn sqrt(&self) -> Result<Value> {
        ...
        match self {
            ...
            | F32(_) | F64(_) => {
                let a : OrderedFloat<f64> = self.try_into()?;
                Ok(Value::F64(OrderedFloat::from(a.sqrt())))
            }
            Null => Ok(Value::Null),
...
mod tests {
    ...
    fn evaluate_eq() {
        ...
        assert!(I64(1).evaluate_eq(&F64(OrderedFloat::from(1.0))));
        assert!(F32(OrderedFloat::from(1.0_f32)).evaluate_eq(&I64(1)));
        assert!(F32(OrderedFloat::from(6.11_f32)).evaluate_eq(&F64(OrderedFloat::from(6.11))));
        assert!(F64(OrderedFloat::from(1.0)).evaluate_eq(&I64(1)));
        assert!(F64(OrderedFloat::from(6.11)).evaluate_eq(&F64(OrderedFloat::from(6.11))));
    ...
    fn cmp() {
        ...
        assert_eq!(F64(OrderedFloat::from(1.0)).evaluate_cmp(&F64(OrderedFloat::from(1.0))), Some(Ordering::Equal));
    ...
    fn is_zero() {
        for i in -1..2 {
            ...
            assert_eq!(F32(OrderedFloat::from(i as f32)).is_zero(), i == 0);
            assert_eq!(F64(OrderedFloat::from(i as f64)).is_zero(), i == 0);
    ...
    fn arithmetic() {
        ...
        test!(add I8(1),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));

        test!(add I32(1),   I8(2)    => I32(3));
        test!(add I32(1),   I16(2)    => I32(3));
        test!(add I32(1),   I32(2)   => I32(3));
        test!(add I32(1),   I64(2)   => I64(3));
        test!(add I32(1),   F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        test!(add I32(1),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));

        test!(add I64(1),   I8(2)    => I64(3));
        test!(add I64(1),   I16(2)    => I64(3));
        test!(add I64(1),   I32(2)   => I64(3));
        test!(add I64(1),   I64(2)   => I64(3));
        test!(add I64(1),   F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        test!(add I64(1),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));

        test!(add I128(1),   I8(2)    => I128(3));
        test!(add I128(1),   I16(2)    => I128(3));
        test!(add I128(1),   I32(2)   => I128(3));
        test!(add I128(1),   I64(2)   => I128(3));
        test!(add I128(1),   F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        test!(add I128(1),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        ...
        test!(add U8(1),   F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        test!(add U8(1),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        ...
        test!(add U16(1),   F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        test!(add U16(1),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        ...
        test!(add U32(1),   F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        test!(add U32(1),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        ...
        test!(add U64(1),   F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        test!(add U64(1),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        ...
        test!(add U128(1),   F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        test!(add U128(1),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));

        test!(add F32(OrderedFloat(1.0_f32)), F32(OrderedFloat(2.0_f32)) => F32(OrderedFloat(3.0_f32)));
        test!(add F32(OrderedFloat(1.0_f32)), F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        ...
        test!(add F64(OrderedFloat::from(1.0)), F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        test!(add F64(OrderedFloat::from(1.0)), F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        test!(add F64(OrderedFloat::from(1.0)), I8(2)    => F64(OrderedFloat::from(3.0)));
        test!(add F64(OrderedFloat::from(1.0)), I32(2)   => F64(OrderedFloat::from(3.0)));
        test!(add F64(OrderedFloat::from(1.0)), I64(2)   => F64(OrderedFloat::from(3.0)));
        test!(add F64(OrderedFloat::from(1.0)), U8(2)    => F64(OrderedFloat::from(3.0)));
        ...
        test!(subtract U8(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(1.0)));
        ...
        test!(subtract U16(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(1.0)));
        ...
        test!(subtract U32(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(1.0)));
        ...
        test!(subtract U64(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(1.0)));
        ...
        test!(subtract U128(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(1.0)));
        ...
        test!(subtract I8(3),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(1.0)));
        test!(subtract I32(3),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(1.0)));
        test!(subtract I64(3),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(1.0)));
        test!(subtract I128(3),  F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(1.0)));
        ...
        test!(subtract F32(OrderedFloat(3.0_f32)), F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(1.0)));
        ...
        test!(subtract F64(OrderedFloat::from(3.0)), F32(OrderedFloat(2.0_f32)) => F32(OrderedFloat(1.0_f32)));
        test!(subtract F64(OrderedFloat::from(3.0)), F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(1.0)));
        test!(subtract F64(OrderedFloat::from(3.0)), I8(2)    => F64(OrderedFloat::from(1.0)));
        test!(subtract F64(OrderedFloat::from(3.0)), I64(2)   => F64(OrderedFloat::from(1.0)));
        test!(subtract F64(OrderedFloat::from(3.0)), U8(2)   => F64(OrderedFloat::from(1.0)));
        ...
        test!(multiply I8(3),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(6.0)));
        test!(multiply I16(3),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(6.0)));
        test!(multiply I32(3),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(6.0)));
        test!(multiply I64(3),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(6.0)));
        test!(multiply I128(3),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(6.0)));
        test!(multiply I128(3),    U8(2) => I128(6));
        ...
        test!(multiply U8(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(6.0)));
        ...
        test!(multiply U16(3),   F32(OrderedFloat::from(2.0_f32))  => F64(OrderedFloat::from(6.0)));
        test!(multiply U16(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(6.0)));
        ...
        test!(multiply U32(3),   F32(OrderedFloat::from(2.0_f32))  => F64(OrderedFloat::from(6.0)));
        test!(multiply U32(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(6.0)));
        ...
        test!(multiply U64(3),   F32(OrderedFloat::from(2.0_f32))  => F64(OrderedFloat::from(6.0)));
        test!(multiply U64(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(6.0)));
        ...
        test!(multiply U128(3),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(6.0)));

        test!(multiply F32(OrderedFloat::from(3.0_f32)), F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(6.0_f32)));
        test!(multiply F32(OrderedFloat::from(3.0_f32)), F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(6.0)));
        ...
        test!(multiply F64(OrderedFloat::from(3.0)), F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(6.0)));
        test!(multiply F64(OrderedFloat::from(3.0)), F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(6.0_f32)));
        test!(multiply F64(OrderedFloat::from(3.0)), I8(2)    => F64(OrderedFloat::from(6.0)));
        test!(multiply F64(OrderedFloat::from(3.0)), I32(2)   => F64(OrderedFloat::from(6.0)));
        test!(multiply F64(OrderedFloat::from(3.0)), I64(2)   => F64(OrderedFloat::from(6.0)));
        test!(multiply F64(OrderedFloat::from(3.0)), I128(2)  => F64(OrderedFloat::from(6.0)));
        test!(multiply F64(OrderedFloat::from(3.0)), U8(2)    => F64(OrderedFloat::from(6.0)));
        ...
        test!(multiply F64(OrderedFloat::from(3.0)), mon!(3)  => mon!(9));
        ...
        test!(multiply mon!(3),  F32(OrderedFloat::from(2.0_f32)) => mon!(6));
        test!(multiply mon!(3),  F64(OrderedFloat::from(2.0)) => mon!(6));
        ...
        test!(divide U8(6),   F32(OrderedFloat::from(2.0_f32))  => F64(OrderedFloat::from(3.0)));
        test!(divide U8(6),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(3.0)));
        ...
        test!(divide U16(6),   F32(OrderedFloat::from(2.0_f32))  => F64(OrderedFloat::from(3.0)));
        test!(divide U16(6),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(3.0)));
        ...
        test!(divide U32(6),   F32(OrderedFloat::from(2.0_f32))  => F64(OrderedFloat::from(3.0)));
        test!(divide U32(6),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(3.0)));
        ...
        test!(divide U64(6),   F32(OrderedFloat::from(2.0_f32))  => F64(OrderedFloat::from(3.0)));
        test!(divide U64(6),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(3.0)));
        ...
        test!(divide U128(6),   F64(OrderedFloat::from(2.0))  => F64(OrderedFloat::from(3.0)));

        test!(divide I8(6),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        test!(divide I32(6),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        test!(divide I64(6),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        test!(divide I128(6),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        test!(divide F32(OrderedFloat::from(6.0_f32)),    F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(3.0)));
        ...
        test!(divide F64(OrderedFloat::from(6.0)), F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        ...
        test!(divide F64(OrderedFloat::from(6.0)), I8(2)    => F64(OrderedFloat::from(3.0)));
        test!(divide F64(OrderedFloat::from(6.0)), I16(2)    => F64(OrderedFloat::from(3.0)));
        test!(divide F64(OrderedFloat::from(6.0)), I32(2)    => F64(OrderedFloat::from(3.0)));
        test!(divide F64(OrderedFloat::from(6.0)), I64(2)   => F64(OrderedFloat::from(3.0)));
        test!(divide F64(OrderedFloat::from(6.0)), I128(2)    => F64(OrderedFloat::from(3.0)));
        test!(divide F64(OrderedFloat::from(6.0)), U8(2)    => F64(OrderedFloat::from(3.0)));
        test!(divide F64(OrderedFloat::from(6.0)), F32(OrderedFloat::from(2.0_f32)) => F32(OrderedFloat::from(3.0_f32)));
        ...
        test!(divide mon!(6),  F64(OrderedFloat::from(2.0)) => mon!(3));
        ...
        test!(modulo I8(6),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(0.0)));
        test!(modulo I32(6),   I32(2)   => I32(0));
        test!(modulo I32(6),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(0.0)));
        test!(modulo I64(6),   I32(2)   => I32(0));
        test!(modulo I64(6),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(0.0)));
        ...
        test!(modulo F64(OrderedFloat::from(6.0)), I64(2)   => F64(OrderedFloat::from(0.0)));
        test!(modulo F64(OrderedFloat::from(6.0)), F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(0.0)));
        ...
        test!(modulo I128(6),   F64(OrderedFloat::from(2.0)) => F64(OrderedFloat::from(0.0)));
        ...
        null_test!(add      F64(OrderedFloat::from(1.0)), Null);
        ...
        null_test!(subtract F64(OrderedFloat::from(1.0)), Null);
        ...
        null_test!(multiply F64(OrderedFloat::from(1.0)), Null);
        ...
        null_test!(divide   F64(OrderedFloat::from(1.0)), Null);
        ...
        null_test!(modulo   F64(OrderedFloat::from(1.0)), Null);
        ...
        null_test!(add      Null, F64(OrderedFloat::from(1.0)));
        ...
        null_test!(subtract Null, F64(OrderedFloat::from(1.0)));
        ...
        null_test!(multiply Null, F64(OrderedFloat::from(1.0)));
        ...
        null_test!(divide   Null, F64(OrderedFloat::from(1.0)));
        ...
        null_test!(modulo   Null, F64(OrderedFloat::from(1.0)));
    ...
    fn cast() {
        ...
        cast!(F64(OrderedFloat::from(1.0))              => Float        , F64(OrderedFloat::from(1.0)));
        ...
        cast!(F64(OrderedFloat::from(1.0))                  => Boolean, Bool(true));
        cast!(F64(OrderedFloat::from(0.0))                  => Boolean, Bool(false));
        ...
        cast!(F64(OrderedFloat::from(1.1))              => Int8, I8(1));
        ...
        cast!(F64(OrderedFloat::from(1.1))              => Int32, I32(1));
        ...
        cast!(F64(OrderedFloat::from(1.1))              => Int, I64(1));
        ...
        cast!(F64(OrderedFloat::from(1.1))              => Int128, I128(1));
        ...
        cast!(F64(OrderedFloat::from(1.1))              => Uint8, U8(1));
        ...
        cast!(F64(OrderedFloat::from(1.1))              => Uint16, U16(1));
        ...
        cast!(F64(OrderedFloat::from(1.1))              => Uint32, U32(1));
        ...
        cast!(F64(OrderedFloat::from(1.1))              => Uint64, U64(1));
        ...
        cast!(F64(OrderedFloat::from(1.1))              => Uint128, U128(1));
        ...
        cast!(F64(OrderedFloat::from(1.0))               => Float32, F32(OrderedFloat(1.0_f32)));

        // Float
        cast!(Bool(true)            => Float, F64(OrderedFloat::from(1.0)));
        cast!(Bool(false)           => Float, F64(OrderedFloat::from(0.0)));
        cast!(I8(1)                 => Float, F64(OrderedFloat::from(1.0)));
        cast!(I16(1)                 => Float, F64(OrderedFloat::from(1.0)));
        cast!(I32(1)                => Float, F64(OrderedFloat::from(1.0)));
        cast!(I64(1)                => Float, F64(OrderedFloat::from(1.0)));
        cast!(I128(1)               => Float, F64(OrderedFloat::from(1.0)));
        cast!(F32(OrderedFloat(1_f32))               => Float, F64(OrderedFloat::from(1.0)));

        cast!(U8(1)                 => Float, F64(OrderedFloat::from(1.0)));
        cast!(U16(1)                 => Float, F64(OrderedFloat::from(1.0)));
        cast!(U32(1)                 => Float, F64(OrderedFloat::from(1.0)));
        cast!(U64(1)                 => Float, F64(OrderedFloat::from(1.0)));
        cast!(U128(1)                 => Float, F64(OrderedFloat::from(1.0)));
        cast!(Str("11".to_owned())  => Float, F64(OrderedFloat::from(11.0)));
        ...
        cast!(F64(OrderedFloat::from(1.0))      => Text, Str("1".to_owned()));
    ...
    fn concat() {
        ...
        assert_eq!(Str("A".to_owned()).concat(F64(OrderedFloat::from(1.0))), Str("A1".to_owned()));
        assert_eq!(
    ...
    fn validate_type() {
        ...
        assert!(F64(OrderedFloat::from(1.0)).validate_type(&D::Float).is_ok());
        assert!(F64(OrderedFloat::from(1.0)).validate_type(&D::Int).is_err());
    ...
    fn unary_minus() {
        ...
        assert_eq!(F64(OrderedFloat::from(1.0)).unary_minus(), Ok(F64(OrderedFloat::from(-1.0))));
        assert_eq!(
    ...
    fn factorial() {
        ...
        assert_eq!(
            F64(OrderedFloat::from(5.0)).unary_factorial(),
            Err(ValueError::FactorialOnNonInteger.into())
        );
    ...
    #[test]
    fn sqrt() {
        assert_eq!(I8(9).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(I16(9).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(I64(9).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(I128(9).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(U8(9).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(U16(9).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(U32(9).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(U64(9).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(U128(9).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(F32(OrderedFloat::from(9.0_f32)).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
        assert_eq!(F64(OrderedFloat::from(9.0)).sqrt(), Ok(F64(OrderedFloat::from(3.0))));
    ...
    fn get_type() {
        ...
        assert_eq!(F64(OrderedFloat::from(1.1)).get_type(), Some(D::Float));
